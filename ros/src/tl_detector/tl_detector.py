...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, pose):
        ...
        """
        #TODO implement - Implemented as follows
    ...
    def process_traffic_lights(self):
        """
        fFinds closest visible traffic light, if one exists, and determines its
            location and color
